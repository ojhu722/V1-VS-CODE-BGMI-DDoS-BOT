    ...
    if action == '/approve':
        if plan == 1:  # Basic Plan 🧡
            ...
            if users_collection.count_documents({"plan": 2}) >= 499:
                bot.send_message(chat_id, "*Approval failed: Basic Plan 💥 limit reached (499 users).*", parse_mode='Markdown')
                return
...
def send_welcome(message):
    ...
    btn2 = KeyboardButton("Basic Plan 💥")
